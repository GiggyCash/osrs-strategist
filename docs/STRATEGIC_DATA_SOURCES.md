...
| Reviewed task economics | [Slayer training](https://oldschool.runescape.wiki/w/Slayer_training), [Duradel assignments](https://oldschool.runescape.wiki/w/Duradel/Slayer_assignments), [Nieve](https://oldschool.runescape.wiki/w/Nieve), [Chaeldar](https://oldschool.runescape.wiki/w/Chaeldar), and matching Slayer-task pages | Fifty-four detailed families have qualitative XP, resource, duration, setup, attention, required-item, risk, selected weight, and alternative properties. Exact kill rates and supply consumption are deliberately not retained. |
