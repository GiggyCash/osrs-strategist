...
public enum SlayerReward
{
    ...
    MALEVOLENT_MASQUERADE("malevolent-masquerade", Text.get(1180), 400,
    ...
    ACTUAL_VAMPYRE_SLAYER("actual-vampyre-slayer", Text.get(1181), 80,
            VarbitID.SLAYER_UNLOCK_VAMPYRES),
    REPTILE_GOT_RIPPED("reptile-got-ripped", Text.get(1182), 75,
    ...
    EXTEND_DUST_DEVILS("extend-dust-devils", Text.get(1183), 100,
